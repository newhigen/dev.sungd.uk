...
| `tab-styles.html` | 탭마다 쓰는 판 (정해짐) — ① 전과 후는 같은 축에 두 가지, ② 막힌 지점은 값을 그림으로, ③ 개발기는 축 하나에 매단다 |
| `making-merge.html` | 개발기의 축과 카드를 합칠까 — 지금(따로)과 여섯 안(M1 목차 · M2 매달기 · M3 펼침 · M4 붙어 따라옴 · M5 세로 축 · M6 지도와 창). 실제 편 폭 782px |
| `making-scroll.html` | 개발기 창 테두리 고르기 — 밀어서 바꾸는 판과 가운데 창은 정해졌고, 두르는 법 다섯(B1 사방 실선 · B2 꺾쇠 · B3 테두리만 · B4 글로 이어짐 · B5 이름표) |
| `making-decide.html` | 「의사결정 방식」 절 — 스크린샷을 지키면서 다섯(P1 절차+격자 · P2 한 줄로 밀기 · P3 갈래마다 한 줄 · P4 크게+썸네일 · P5 물음이 주인공). 실제 편 폭 782px |
